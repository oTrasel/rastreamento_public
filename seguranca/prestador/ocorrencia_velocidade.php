...
<head>
    ...
    <link rel="stylesheet" href="../css/ocorrencia_vel.css">
    <link rel="shortcut icon" href="../images/favicon.ico" />
    <title>Ocorrência de velocidade</title>
</head>
<?php
include('../layout.php');
include('../manager/auxiliares/busca_ocorrencia_velocidade.php');
?>
    ...
    <div class="container">
        <div class="children">
            ...
            <div class="ocrSemJustificativa">
                <form action="../manager/cadastros/processa_justificativa_vel.php" method="post" id="formJustificativa">
                    <h6>Ocorrências de Velocidade sem JUSTIFICATIVA</h6>
                    <table class="table table-striped" id="tableInfos">
                        ...
                        <tbody id="conteudo">
                            ...
                            if ($row !== 0) {
                                $index = 0;
                                foreach ($ocrVel as $ocr) {
                                    $index++;
                                    echo '
                                    <tr>
                                        <td>' . $ocr['ID_OCORRENCIA'] . '</td>
                                        <td>' . $ocr['PLACA'] . '</td>
                                        <td>' . $ocr['DT_OCORRENCIA'] . '</td>
                                        <td>' . $ocr['OCORRENCIA'] . '</td>
                                        <td>' . $ocr['VELOCIDADE'] . '</td>
                                        <td><div class="form-check form-switch checkBoxs"><input class="form-check-input inputCheck" type="checkbox" role="switch" id="justCheckbox_' . $index . '" value="' . $ocr['ID_OCORRENCIA'] . '" name="selecoes[]"></div> </td>
                                    </tr>';
                                }
                            }
                            ?>
            ...
            <div class="ocrJustificadas">
                <h6>Ocorrência de Velocidade Justificadas</h6>
...
<script src="../js/paginas/prestador/ocorrencia_velocidade.js"></script>
