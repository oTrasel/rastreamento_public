...
CONVERT(VARCHAR, tv.DT_ULT_POSICAO, 103) + ' ' + CONVERT(VARCHAR, tv.DT_ULT_POSICAO, 108) AS 'ultima_posicao' ,
...
group by vpg.data_entrada, vpg.id_vinculo, pv.descr_placa , g.descr_gps, VELOCIDADE, tv.quadra, tv.RUA, tv.DT_ULT_POSICAO
");
